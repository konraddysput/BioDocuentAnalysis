...
def generate_centroids(vocabulary_path: str, vocabulary_length: int, idfs_cache_file: str,
                       centroids_neighbourhood_size: int, centroids_file_path: str):
    query_expander = QueryExpander(vocabulary_path, vocabulary_length, idfs_cache_file, centroids_file_path)
...
def expand(query: str, vocabulary_path: str, vocabulary_length: int, number_of_additional_words: int,
           idfs_cache_file: str, centroids_file_path: str):
    query_expander = QueryExpander(vocabulary_path, vocabulary_length, idfs_cache_file, centroids_file_path)
...
def expand_file(input_file_path: str, output_file_path: str, vocabulary_path: str, vocabulary_length: int,
                number_of_additional_words: int, idfs_cache_file: str, centroids_file_path: str):
    query_expander = QueryExpander(vocabulary_path, vocabulary_length, idfs_cache_file, centroids_file_path)
