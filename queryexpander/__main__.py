...
def generate_cache(vocabulary_path: str, vocabulary_length: int):
    query_expander = QueryExpander(vocabulary_path, vocabulary_length)
...
def expand_file(input_file_path: str, output_file_path: str, vocabulary_path: str, vocabulary_length: int,
                number_of_additional_words: int):
    query_expander = QueryExpander(vocabulary_path, vocabulary_length)
